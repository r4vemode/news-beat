        ...
        <>
            <div className={'oneArticle'}>
                <div className="container">
                    <div>
                        <ul className="logo__list stat">
                            <li className="logo__item"><a href="/" className="logo__link"><h1
                                className="header__title mb">News Beat</h1></a></li>
                            <li className="logo__item"></li>
                        </ul>
                    </div>
                    ...
                    <div className="oneArticle__container">
                        <div className="oneArticle__state-container">
                            <div className="oneArticle__category">
                                <svg xmlns="http://www.w3.org/2000/svg" width="34" height="34" viewBox="0 0 44 44"
                                     fill="none">
                                    <path d="M20.1667 38.5H38.5" stroke="#1B1B1B" strokeWidth="1.5"
                                          strokeLinecap="round"/>
                                    <path fillRule="evenodd" clipRule="evenodd"
                                          ...
                                          stroke="#1B1B1B" strokeWidth="1.5" strokeLinecap="round"
                                          strokeLinejoin="round"/>
                                    <path d="M18.9941 13.3693L27.3634 20.6783" stroke="#1B1B1B" strokeWidth="1.5"
                        ...
                        <div className="oneArticle__text-container">
                            <h1 className="oneArticle__title">
                                Голову и руки достали из желудка: жуткие подробности трагедии с акулой-людоедом в
                                Египте.
                            </h1>
                            <p className="oneArticle__text">
                                Появились подробности трагедии, произошедшей 8 июня в Хургаде. Акула набросилась на
                                23-летнего россиянина Владимира Попова и растерзала его на глазах у отца за считанные
                                секунды. <br/>
                                <br/>
                                Через несколько часов после трагедии хищную рыбу удалось поймать. В ее желудке нашли
                                голову, грудь и две руки погибшего молодого человека.<br/>
                                <br/>
                                Нижнюю часть тела обнаружили в море вечером. Акула бросила ее из-за приближения лодки
                                рыбаков, которые пытались спасти туриста.<br/>
                                <br/>
                                По данным Al-Arabiya, министерство окружающей среды Египта передало тушу хищной рыбы в
                                институт для научного исследования. Специалисты попытаются понять, что стало причиной
                                изменения поведения акулы.<br/>
                                <br/>
